...
public final class DlgRujuk extends javax.swing.JDialog {
    ...
    public DlgRujuk(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={
            ...
            "Pemeriksaan Radiologi","Pemeriksaan Lab","Terapi","Diagnosa","Kode Dokter","Nama Dokter"
    ...
    private void initComponents() {
        ...
        DTPRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-08-2023" }));
        ...
        jLabel20.setText("Pemeriksaan Lab:");
        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(490, 210, 110, 23);
        ...
        scrollPane1.setBounds(100, 230, 370, 80);
        ...
        scrollPane2.setBounds(530, 330, 370, 80);

        jLabel28.setText("Terapi:");
        jLabel28.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(490, 310, 50, 23);
        ...
        btnTerapi.setBounds(910, 360, 28, 23);
        ...
        btnPemeriksaanPj.setBounds(470, 360, 28, 23);
        ...
        scrollPane3.setBounds(100, 330, 370, 80);
        ...
        btnPemeriksaanLab.setBounds(910, 260, 28, 23);
        ...
        scrollPane4.setBounds(530, 230, 370, 80);

        jLabel34.setText("Pemeriksaan Fisik:");
        jLabel34.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(0, 210, 130, 23);

        jLabel35.setText("Pemeriksaan Radiologi:");
        jLabel35.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(10, 310, 140, 23);
    ...
    */
    ...
    public void tampil() {
        ...
        try{
            ...
            sql="select rujuk.no_rujuk,rujuk.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                ...
                "rujuk.pemeriksaan,rujuk.pemeriksaanpj,rujuk.pemeriksaanlab,rujuk.terapi,rujuk.keterangan_diagnosa,rujuk.kd_dokter,dokter.nm_dokter "+
                "from rujuk inner join reg_periksa inner join pasien inner join dokter "+
                "on rujuk.no_rawat=reg_periksa.no_rawat "+
                "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "and rujuk.kd_dokter=dokter.kd_dokter "+
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TDiagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            KdDok.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            TDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
