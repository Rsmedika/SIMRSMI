...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnAmbilPhoto1.setBounds(910, 120, 150, 30);
        ...
        BtnSimpan1.setBounds(920, 150, 200, 30);
        ...
        BtnDokter2.setBounds(920, 60, 130, 23);
        ...
        BtnDokter3.setBounds(910, 90, 110, 23);
        ...
        BtnPanggilPasien.setBounds(970, 10, 130, 30);
                        ...
                        if(KdPeg.getText().trim().equals("")||TPegawai.getText().trim().equals("")){
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                ...
                                if(akses.getkode().equals(KdPeg.getText())){
                                    ...
                                    Sequel.menyimpan("mutasi_berkas","'"+TNoRw.getText()+"','Sudah Periksa',now(),now(),NOW() + INTERVAL 1 MINUTE,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00'","status='Sudah Periksa',sudah=NOW() + INTERVAL 1 MINUTE","no_rawat='"+TNoRw.getText()+"'"); //edit-novan
                                }else{
