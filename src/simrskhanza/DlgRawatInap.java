...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnAmbilPhoto1.setBounds(920, 90, 150, 30);
        ...
        BtnSimpan1.setBounds(920, 120, 200, 30);
        ...
        BtnDokter2.setBounds(930, 40, 130, 23);
        ...
        BtnDokter3.setBounds(920, 70, 110, 23);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnTemplateResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplateResepActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            template.isCek();
            template.setRM(TNoRw.getText(),TNoRM.getText(),KdDok.getText(),Sequel.cariIsi("select reg_periksa.kd_pj from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()),"ranap");
            template.tampil();
