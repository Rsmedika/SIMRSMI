...
public class DlgPasienMati extends javax.swing.JDialog {
    ...
    private String sql=" pasien_mati.no_rkm_medis=pasien.no_rkm_medis  ",finger="";
    ...
    public DlgPasienMati(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No Surat","Tanggal","Jam","No.R.Medik","Nama Pasien","J.K.","Tmp.Lahir",
                      ...
                      "ICD-X","Antara 1","Antara 2","Langsung","Kode Dokter","Nama Dokter"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratMati2 = new javax.swing.JMenuItem();
        ...
        MnCetakSuratMati2.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakSuratMati2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratMati2.setForeground(java.awt.Color.darkGray);
        MnCetakSuratMati2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakSuratMati2.setText("Surat Kematian 2");
        MnCetakSuratMati2.setName("MnCetakSuratMati2"); // NOI18N
        MnCetakSuratMati2.setPreferredSize(new java.awt.Dimension(250, 28));
        MnCetakSuratMati2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratMati2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratMati2);
        ...
        panelBiasa1.setPreferredSize(new java.awt.Dimension(610, 240));
        ...
        jLabel9.setBounds(10, 210, 100, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-04-2023" }));
        ...
        BtnSeek.setBounds(610, 50, 28, 23);
        ...
        jLabel16.setBounds(10, 180, 100, 23);
        ...
        panelBiasa1.add(TKtg1);
        TKtg1.setBounds(120, 180, 536, 23);

        kddok.setName("kddok"); // NOI18N
        panelBiasa1.add(kddok);
        kddok.setBounds(120, 210, 60, 24);

        NmDokter.setName("NmDokter"); // NOI18N
        panelBiasa1.add(NmDokter);
        NmDokter.setBounds(190, 210, 200, 24);
        ...
        BtnDokter.setBounds(390, 210, 28, 23);
...
private void MnCetakSuratMatiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratMatiActionPerformed
      if(TPasien.getText().trim().equals("")){
          ...
          Map<String, Object> param = new HashMap<>(); 
            ...
            Valid.MyReportqry("rptSuratKematian.jasper","report","::[ Surat Kematian ]::",
                        "select no_surat,tanggal,jam,pasien_mati.no_rkm_medis,pasien.nm_pasien, "+
    ...
    private void MnCetakSuratMati2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratMati2ActionPerformed
      if(TPasien.getText().trim().equals("")){
          JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");                
      }else{
          Map<String, Object> param = new HashMap<>(); 
    ...
    }//GEN-LAST:event_MnCetakSuratMati2ActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakSuratMati2;
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select pasien_mati.no_surat,pasien_mati.tanggal,pasien_mati.jam,pasien_mati.no_rkm_medis,pasien.nm_pasien, "+
                   ...
                   "pasien.agama,pasien_mati.keterangan,pasien_mati.temp_meninggal,pasien_mati.icd1,pasien_mati.icd2,pasien_mati.icd3,"+
                   "pasien_mati.icd4,pasien_mati.kddok,dokter.nm_dokter "+
                   "from pasien_mati inner join pasien inner join dokter on pasien_mati.kddok=dokter.kd_dokter and pasien_mati.no_rkm_medis=pasien.no_rkm_medis where "+
                    sql+"and pasien_mati.no_surat like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and tanggal like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien_mati.no_rkm_medis like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and nm_pasien like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien.jk like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien.tmp_lahir like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien.gol_darah like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien.stts_nikah like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and pasien.agama like '%"+TCari.getText().trim()+"%' or "+
                    sql+"and keterangan like '%"+TCari.getText().trim()+"%' "+
    ...
    private void getData() {
        if(tbMati.getSelectedRow()!= -1){
            ...
            kddok.setText(tbMati.getValueAt(tbMati.getSelectedRow(),17).toString());
