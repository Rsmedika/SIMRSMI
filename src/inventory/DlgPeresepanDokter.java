...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-09-2023" }));
        ...
        jLabel4.setText("Jadikan Template Resep :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(710, 70, 123, 23);
        ...
        NamaTemplate.setBounds(840, 70, 280, 23);
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat","?,?,?,?,?,?,?,?,?,?,?","Nomer Resep",11,new String[]{
                        ...
                        cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),status,"0000-00-00","00:00:00",NamaTemplate.getText()
                        })==true){
                            simpandata();
                    }else{
                        emptTeksobat();
